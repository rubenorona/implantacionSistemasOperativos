...
20. [EXTRA: Conexión remota de Linux a Windows (Remmina)](./tarefas/extra_RemotoLinuxRemmina.pdf)
21. [EXTRA: Instalación desatendida en Windows mediante software de terceiros (NTLite)](./tarefas/extra_instalacionDesatendidaTerceiros.pdf)
22. [EXTRA: Xeración dun arquivo de respostas WDS para a instalación desatendida](./tarefas/extra_arquivoRespostaWDS.pdf)
23. [EXTRA: Configuración do rol de cotas de disco en Windows](./tarefas/extra_RolCotasDisco.pdf)
24. [EXTRA: Configuración dun perfil superobrigatorio en Windows](./tarefas/extra_perfilSuperobrigatorio.pdf)
